  ...
  return (
    <div className='flex items-center w-full mx-auto h-screen diagonal-background'>
        ...
        className='grid place-items=center lg:w-5/12 w-11/12 mx-auto bg-white text-[#4f7cff] shadow-2xl rounded-3xl'>
           ...
           {/* fullname */}
            <div className='w-full flex flex-col px-14 py-8'><label>fullname</label>
            <input type="text" className='w-full border border-gray-300 rounded-lg px-3 py-3 mt-1 text-lg outline-none' placeholder='your fullname' required value={fullname} onChange={(e)=>{setFullname(e.target.value)}}></input></div>
...
<div className='mx-auto flex justify-center items-center pt-6 pb-16'>
    ...
    <button type="submit" className='bg-[#3d5fc4] text-white rounded-md text-base uppercase w-24 py-2'>Register</button>
</div>
        </form>
    </div>
  )
